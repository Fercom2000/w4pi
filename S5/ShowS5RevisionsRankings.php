<form name=cform action="./ShowS5RevisionsRankings.php" method="post">
  ...
  echo ("<br><h2>Comments for this Leaflet</h2><br>
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo ("<tr class='cRow'><td class='commentWindow small'>"
                //."<input type='text' name='revisions' id='revisions' size='3' class='hidden' value='"
                .$row["idCrwRevision"]//."'>"
                ...
                . $row["flag"]."</td>"
                //."<td class='commentWindow'><label><input type='radio' name='".$row["idCrwRevision"]."' value='1'>Test</label><label><input type='radio' name='".$row["idCrwRevision"]."' value='2'>Rejected</label><input type='submit' value='Register'></td>"
                ."</tr>");  
      echo "</form>";
      $i=$i+1;      
    }
