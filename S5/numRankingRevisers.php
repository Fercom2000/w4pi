...
echo $query;
$sql = "SELECT *,COUNT(*) AS count FROM mtkCrwRevision WHERE dateT>'2019-11-24' AND rejected=0 GROUP BY idGroup,idReviser; ";//$query;//"SELECT * FROM S6Revision WHERE idSentence=".$SID." ORDER BY RAND() LIMIT 9";
