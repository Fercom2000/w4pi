		...
		<div class="content">
			...
			<div class="eqip70" id="eqip">
				<div class="formCont commentForm containerStyle" id="formCont">
					Thank you for registering, you can now start reviewing our pil, please employ your <h3>AMAZON MECHANICAL TURK ID</h3> when asked for your <h3>REVIEWER ID</h3>
					<?php
					 	/*$page=$_GET['e'];
						...
						if ($result->num_rows > 0) {
							while($row = $result->fetch_assoc()) {
								echo "<h2>THANK YOU FOR REGISTERING YOUR REVIEWER ID IS:</h2> <h1><center>sre3".$row["idReviewer"]."</center></h1>";
								echo "<h3>You can now start reviewing our PIL, please store your reviewer id as it will be needed for each PIL</h3> <BR>If you have lose your reviewer Id please write your Amazon Meachanical Turk Id instead.";
							}
						} else {
