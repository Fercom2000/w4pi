 <?php
	...
	if ($result->num_rows > 0) {
		echo "	<section class='instructions unselectable fixed'>
					<h2>Instructions: Answer the following questions. If more information should be added, include the question number and what you expect to see in the text area at the end.<br><br></h2>
				</section>";
