...
try 
{
	...
	$statement = $pdo->prepare("INSERT INTO mtkkwdQs (idReviser,idLeaflet,kwdQs1,kwdQs2,kwdQs3,kwdQs4,flag)VALUES( :idReviser, :idLeaflet, :kwdQs1,:kwdQs2,:kwdQs3,:kwdQs4,:flag)");
	$statement->execute(array("idReviser"=>$idReviser,"idLeaflet"=>$idLeaflet,"kwdQs1" => $kwdQs1,"kwdQs2" => $kwdQs2,"kwdQs3" => $kwdQs3,"kwdQs4" => $kwdQs4,"flag"=>$flag));
  ...
  <body>
    ...
    <nav class="Menu">
      <ul class="menuL">
        ...
        <li class="menuL"><span class="menuL"><a class="menuL active" name="revCPIL1.html">Generate Code</a></span></li>
        <li class="contact"></li>
      </ul>
    </nav>
    <div class="content">
      <div class="mainC70" id="mainC70">
        <br><h1><center>Thank you for participating in this study</center></h1><br><br>
          <?php
            echo "<h2><center>Your Survey Code is: W4PI-MTK-S02-SRE4".$idReviser."</center></h2>";
          ?>
      </div>
