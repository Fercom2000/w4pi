<form name=cform action="./ShowS3OrgSentences.php" method="post">
...
if ($result->num_rows > 0) {
  echo ("<br><h2>Comments for this Leaflet</h2><br>
        ...
        <table  class='commentWindow' style='width:100%;'>
            <tr class='cRow'>
    ...
    while($row = $result->fetch_assoc()) {
      echo ("<tr class='cRow'><td class='commentWindow small' style='max-width:3vw;'>"
                . $i."</td><td class='commentWindow' style='max-width:3vw;'>"
                . $row["idOrgSentence"]."</td><td class='commentWindow' style='max-width:3vw;'>"
                . $row["SID"]."</td><td class='commentWindow' style='width:30vw;min-width:30%;'>"
                . $row["Sentence"]."</td><td class='commentWindow'>"
                . $row["Section"]."</td><td class='commentWindow' style='max-width:3vw;'>"
                . $row["SMean"]."</td><td class='commentWindow' style='max-width:3vw;'>"
                . $row["SStDev"]."</td><td class='commentWindow' style='max-width:3vw;'>"
                . $row["SCoeVar"]."</td><td class='commentWindow' style='max-width:3vw;'>"
                . $row["flag"]."</td></tr>");  
      $i=$i+1;      
    }
    echo "</tbody>";
