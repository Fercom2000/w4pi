...
try{
	...
	$data = $pdo->query("SELECT * FROM mtkReviser ORDER BY idGroup,idReviser;")->fetchAll();	//"SELECT * INTO OUTFILE 'mydata.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '".'"'."' LINES TERMINATED BY '"."\n"."' FROM mtkCrwRevision GROUP BY idGroup,flag,idReviser,dateT")->fetchAll();//
	...
	echo ("
        ...
        <table  class='commentWindow'>
            <tr class='cRow'>
                ...
                <th class='commentWindow big'>Joinig Date</th>
