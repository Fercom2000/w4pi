 <?php
	...
	if ($result->num_rows > 0) {
		...
		while($row = $result->fetch_assoc()) {
			if($row["idInternal"]=="2" or $row["idInternal"]=="4" or $row["idInternal"]=="7" or $row["idInternal"]=="9" or $row["idInternal"]=="16" or $row["idInternal"]=="17" or $row["idInternal"]=="18" or $row["idInternal"]=="19" or $row["idInternal"]=="22" or $row["idInternal"]=="25" or $row["idInternal"]=="36" or $row["idInternal"]=="37"){
