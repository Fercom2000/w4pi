...
if ($result->num_rows > 0) {
	...
	echo ("<br><h2>Reviewer List</h2><br>
        ...
        <table  class='clozeWord c'>
            <tr class='cRow'><th class='commentWindow readabilitySug'> Id </th>
                <th class='commentWindow readabilitySug'>Question</th>
                <th class='commentWindow readabilitySug'>Reviewer</th>
                <th class='commentWindow readabilitySug'>Description</th>
                <th class='commentWindow readabilitySug'>Concerns</th>
