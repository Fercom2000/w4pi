    ...
    while($row = $result->fetch_assoc()) {
    	if(intval($row["flag"]<1) and $revArr[$row['idReviewer']]){
    		...
    		if(intval($lId)==1){
				...
				echo '
					<div class="paragraphCS  hidden cfs1" id="s1">'.$t3[0].'<span class="blue">'.$row["clozeField1"].'</span>'.$t3[1].'<span class="blue">'.$row["clozeField2"].'</span>'.$t3[2].'<span class="blue">'.$row["clozeField3"].'</span>'.$t3[3].'<span class="blue">'.$row["clozeField4"].'</span>'.$t3[4].'<span class="blue">'.$row["clozeField5"].'</span>'.$t3[5].'<span class="blue">'.$row["clozeField6"].'</span>'.$t3[6].'<span class="blue">'.$row["clozeField7"].'</span>'.$t3[7].'
					</div>
					<div class="paragraphCS  hidden cfs2" id="s2">'.$t3[8].'<span class="blue">'.$row["clozeField8"].'</span>'.$t3[9].'<span class="blue">'.$row["clozeField9"].'</span>'.$t3[10].'<span class="blue">'.$row["clozeField10"].'</span>'.$t3[11].'<span class="blue">'.$row["clozeField11"].'</span>'.$t3[12].'<span class="blue">'.$row["clozeField12"].'</span>'.$t3[13].'<span class="blue">'.$row["clozeField13"].'</span>'.$t3[14].'<span class="blue">'.$row["clozeField14"].'</span>'.$t3[15].'
					</div>
					<div class="paragraphCS  hidden cfs3" id="s3">'.$t3[16].'<span class="blue">'.$row["clozeField15"].'</span>'.$t3[17].'<span class="blue">'.$row["clozeField16"].'</span>'.$t3[18].'<span class="blue">'.$row["clozeField17"].'</span>'.$t3[19].'<span class="blue">'.$row["clozeField18"].'</span>'.$t3[20].'<span class="blue">'.$row["clozeField19"].'</span>'.$t3[21].'<span class="blue">'.$row["clozeField20"].'</span>'.$t3[22].'<span class="blue">'.$row["clozeField21"].'</span>'.$t3[23].'
						</div>
