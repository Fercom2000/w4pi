...
<div class="content">
	...
	<div class="mainWindowA containerStyle pil" id="leafletText" style="width: 35%;max-width: 35%;font-size: 16px;">
		<p class="yellowT">Original Sentence</p><br>	
		<p class="alignTab">2-22: A growing number of people are living for many years after cancer treatment but we don't yet know all the ways to support them to ensure the best possible recovey.</p>
	</div>
	<div class="commentWindowA containerStyle pil" style="width: 65%;max-width: 65%;font-size: 16px;max-height: 60vh; overflow: scroll;">
		<p class="yellowT">Proposed Revisions</p>	
		 <?php
			...
			$sql = "SELECT * FROM mtkCrwRevision WHERE idSentence=264 AND dateT>'2019-11-17'";
			...
			if ($result->num_rows > 0) {
			  ...
			  while($row = $result->fetch_assoc()) {
			    ...
			    echo "<td><div class='customSelect'>
			      <select style='border:4px;' class='revSent' id='revSent".$i."' required>
